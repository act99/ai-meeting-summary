...
echo "1) 실용적 모델 다운로드 (권장) - 정확도 91%, 빠른 처리, 비용 $0"
...
try:
    console.print("📦 Whisper Small 모델 다운로드 중... (244MB)", style="bold blue")
    model = whisper.load_model("small")
    console.print("✅ 실용적 모델 준비 완료! 정확도 91%, 빠른 처리, 비용 $0", style="bold green")
